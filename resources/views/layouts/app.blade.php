                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{ route('sellers.create') }}">Registrar Vendedores</a>
                                <a class="dropdown-item" href="{{ route('sellers.index') }}">Listar Vendedores</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{ route('truck-loads.create') }}">Registrar Hojas de Carga</a>
                                <a class="dropdown-item" href="{{ route('truck-loads.index') }}">Listar Hojas de Carga</a>
                            </div>
                        </li>
                    </ul>
